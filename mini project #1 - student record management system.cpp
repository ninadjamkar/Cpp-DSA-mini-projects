...
string arr1[100], arr2[100], arr3[100], arr4[100], arr5[100], arr6[100], arr7[100], arr8[100], arr9[100];
int total=0;
...
void show()
{
    for(int i=0; i<total; i++)
    {
        ...
        cout<<"DATE OF BIRTH OF STUDENT #"<<i+1<<": "<<arr3[i]<<endl;
        cout<<"CONTACT NUMBER OF STUDENT #"<<i+1<<": "<<arr4[i]<<endl;
        cout<<"E-MAIL ID OF STUDENT #"<<i+1<<": "<<arr5[i]<<endl;
        cout<<"SAP ID OF STUDENT #"<<i+1<<": "<<arr6[i]<<endl;
        cout<<"ROLL NO OF STUDENT #"<<i+1<<": "<<arr7[i]<<endl;
        cout<<"COURSE OF STUDENT #"<<i+1<<": "<<arr8[i]<<endl;
        cout<<"SPECALIZATION OF STUDENT #"<<i+1<<": "<<arr9[i]<<endl;
        cout<<""<<endl;
    }
}
